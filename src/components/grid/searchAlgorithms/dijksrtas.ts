...
Keep track of every distance in a dictionary and override when a faster one
Keep track of every previous node in the dictionary
backtrace to find the fastest route
